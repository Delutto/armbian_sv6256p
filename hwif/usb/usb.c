...
static int ssv_usb_do_device_exit(struct device *d, void *arg)
{
    ...
    if (glue != NULL) {
        ...
        ret = __ssv6xxx_usb_write_reg(glue, 0xc000001c, (regval & 0xfeffffff));
        ret = __ssv6xxx_usb_read_reg(glue, 0xc00000ec, &regval);
        ret = __ssv6xxx_usb_write_reg(glue, 0xc00000ec, (regval & 0xffffefff));
        ret = __ssv6xxx_usb_read_reg(glue, 0xc00000e8, &regval);
        ret = __ssv6xxx_usb_write_reg(glue, 0xc00000e8, (regval | 0x00000004));
        ret = __ssv6xxx_usb_read_reg(glue, 0xc000001c, &regval);
        ret = __ssv6xxx_usb_write_reg(glue, 0xc000001c, (regval | 0x01000000));
    }
    msleep(50);
    return 0;
}
